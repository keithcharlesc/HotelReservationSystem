...
public class PartnerEmployeeSessionBean implements PartnerEmployeeSessionBeanRemote, PartnerEmployeeSessionBeanLocal {
            ...
            try {
                ...
                if (ex.getCause() != null && ex.getCause().getClass().getName().equals("org.eclipse.persistence.exceptions.DatabaseException")) {
                    if (ex.getCause().getCause() != null && ex.getCause().getCause().getClass().getName().equals("java.sql.SQLIntegrityConstraintViolationException")) {
                        throw new PartnerEmployeeUsernameExistException();
                    } else {
    ...
    public List<PartnerEmployeeEntity> retrieveAllPartnerEmployees() {
        Query query = em.createQuery("SELECT p FROM PartnerEmployeeEntity p ORDER BY r.name");
    ...
    public PartnerEmployeeEntity retrievePartnerEmployeeByPartnerEmployeeId(Long partnerEmployeeId) throws PartnerEmployeeNotFoundException {
        ...
        if (partnerEmployeeEntity != null) {
            ...
            throw new PartnerEmployeeNotFoundException("PartnerEmployee ID " + partnerEmployeeId + " does not exist!");
        }
    }
    ...
    public PartnerEmployeeEntity retrievePartnerEmployeeByUsername(String username) throws PartnerEmployeeNotFoundException {
        ...
        try {
            ...
            throw new PartnerEmployeeNotFoundException("PartnerEmployee Username " + username + " does not exist!");
        }
    }
    ...
    public PartnerEmployeeEntity partnerEmployeeLogin(String username, String password) throws InvalidLoginCredentialException {
        ...
        } catch (PartnerEmployeeNotFoundException ex) {
            throw new InvalidLoginCredentialException("Username does not exist or invalid password!");
        }
    }
