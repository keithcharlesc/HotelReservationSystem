            ...
            while (response < 1 || response > 2) {
                ...
                if (response == 1) {
                    try {
                        ...
                        frontOfficeModule = new FrontOfficeModule(roomSessionBean, roomTypeSessionBean, guestSessionBean, reservationSessionBean, nightSessionBean, roomRateSessionBean, exceptionRecordSessionBean, reservationRoomSessionBean, currentEmployeeEntity);
                        menuMain();
